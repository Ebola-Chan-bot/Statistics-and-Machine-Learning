...
%[text] [Coeff,Score,Explained] = StatisticsAndMachineLearning.DimensionalPca(Array,Dimensions)
%[text] %对数组Array在Dimension维度上执行PCA分析
%[text] 
%[text] [Coeff,Score,Explained] = StatisticsAndMachineLearning.DimensionalPca(Array,Dimensions,NumComponents)
...
%[text] [Coeff,Score,Explained] = StatisticsAndMachineLearning.DimensionalPca(Array,[false,true,true,false],4);
%[text] 
